...
interface AmazonS3IconProps extends CommonIconProps {}

const AmazonS3Icon: FC<AmazonS3IconProps> = ({ size }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height={size} viewBox="0 0 428 512">
      <defs>
        <style>
          {`.cls-1 {
        fill: #e25444;
